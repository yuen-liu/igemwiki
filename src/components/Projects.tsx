...
const proposedProjects: Project[] = [
  {
    ...
    description: "A system using NCCs and CRISPR interference to detect and degrade cytotoxic metabolic byproducts that occur during drug synthesis in E. coli.",
    objectives: [
    ...
    impact: "Improves the yield and safety of biopharmaceutical manufacturing by preventing the accumulation of toxic byproducts.",
    status: "proposed",
    icon: Microscope,
  },
  {
    ...
    description: "Coupling enzymatic redox reactions to electrodes to oxidize iron for copper extraction, potentially generating bio-electricity in the process.",
    objectives: [
    ...
    impact: "Offers a sustainable alternative to traditional mining practices and engages mining communities with biodegradable bio-circuitry.",
    status: "proposed",
    icon: Leaf,
  },
  {
    ...
    description: "Designing artificial 'protein highways' and intramolecular tunnels to direct substrates between enzyme active sites, mimicking natural metabolons.",
    objectives: [
    ...
    impact: "Increases the efficiency of complex synthetic metabolic pathways by preventing the loss or degradation of reaction intermediates.",
    status: "proposed",
    icon: Droplet,
  },
  {
    ...
    description: "A 'plug-and-play' library of genetically engineered tags (CPPs, pH-triggers) fused to protein therapeutics to facilitate uptake and endosomal escape.",
    objectives: [
      "Create a library of fusion tags including Cell-Penetrating Peptides (CPPs) and pH-triggered domains",
